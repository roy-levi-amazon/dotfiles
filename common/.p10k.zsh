# Generated by Powerlevel10k configuration wizard on 2025-11-09 at 09:29 UTC.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    brazil_info             # Brazil workspace and version set
    time                    # current time
...
function prompt_brazil_info() {
  ...
  local content
  content=$(<"$dir/packageInfo") || return

  versionset="${content##*versionSet = }"
  versionset="${versionset%%;*}"
  versionset="${versionset//\"/}"

  [[ -z "$versionset" ]] && return

  local pristine_path="$dir/release-info/versionSets/${versionset}.pristine"
  if [[ -r "$pristine_path" ]]; then
    eventid=$(tr ';,' '\n' < "$pristine_path" | grep -o -m1 'eventId=[0-9]*')
    eventid="${eventid#eventId=}"
  fi

  [[ -z "$eventid" ]] && return

  p10k segment -f 182 -t "$folder"
  p10k segment -f 180 -t "$versionset"
  p10k segment -f 178 -t "$eventid"
}
